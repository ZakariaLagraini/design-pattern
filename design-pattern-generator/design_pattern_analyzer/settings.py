"""
Django settings for design_pattern_analyzer project.
...
SECRET_KEY = 'django-insecure-##99f!&q*kgi9%n(dnsh65ytx_uyq0ihx^tf62h9!p=)j(mfzj'
...
WSGI_APPLICATION = 'design_pattern_analyzer.wsgi.application'
...
# Async settings
ASGI_APPLICATION = 'design_pattern_analyzer.asgi.application'
